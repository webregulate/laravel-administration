<div>
    ...
    >
        <div @class([
            'flex flex-wrap gap-6 p-2',
            'mt-4 p-4 bg-slate-100 dark:bg-slate-800 dark:border-slate-700 border shadow-slate-300 dark:shadow-slate-850 rounded-lg shadow-lg' => !$inModal,
        ])>
